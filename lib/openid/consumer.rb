...
module OpenID
  ...
  # OpenID::OpenIDConsumer.beginAuth or OpenID::OpenIDConsumer.completeAuth
  # methods return successfully.
  SUCCESS = 'success'

  # Code OpenID::OpenIDConsumer.completeAuth
  # returns when the value it received indicated an invalid login.
  FAILURE = 'failure'

  # Code returned by OpenID::OpenIDConsumer.completeAuth when the
  # OpenIDConsumer instance is in immediate mode and ther server sends back a
  # URL for the user to login with.
  SETUP_NEEDED = 'setup needed'  

  # Code returned by OpenID::OpenIDConsumer.beginAuth when it is unable
  # to fetch the URL given by the user.
  HTTP_FAILURE = 'http failure'

  # Code returned by OpenID::OpenIDConsumer.beginAuth when the page fetched
  ...
  # OpenID::OpenIDConsumer.beginAuth>.  If beginAuth completes successfully,
  ...
  #
  # The next step is to call the OpenID::OpenIDConsumer.constructRedirect>}}
  ...
  # OpenID::OpenIDConsumer.constructRedirect
  #
  ...
  # OpenID::OpenIDConsumer.constructRedirect call
  ...
  # object, and call its OpenID::OpenIDConsumer.completeAuth method with that
  ...
  # OpenID::OpenIDConsumer.completeAuth for a full
  ...
  class OpenIDConsumer
    ...
    # ==Parameters
    # [+user_url+]
    #   Identity URL given by the user. beginAuth takes care of
    ...
    # OpenIDConsumer.constructRedirect method.  Second, the token could be
